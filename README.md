...
ImageButton.Image = "http://www.roblox.com/asset/?id=75540555458334"
...
local Window = Fluent:CreateWindow({
    Title = "quocdunghacker",
    SubTitle = "Blox Fruit and all game",
    TabWidth = 157,
...
local Tabs = {
        ...
        Main3=Window:AddTab({ Title="script by TBoy (lấy từ youtube)" }),
        Main4=Window:AddTab({ Title="Script Hop" }),
       Main5=Window:AddTab({ Title="script pvp" }),
        Main6=Window:AddTab({ Title="script kaitun" }),
       Main7=Window:AddTab({ Title="lin tinh" }),
        Main8=Window:AddTab({ Title="lin tinh" }),
}
    Tabs.Main0:AddButton({
    Title = "Discord",
    Description = "quocdung",
    Callback = function()
        setclipboard("https://discord.gg/2QTh2nJ3")
    end
})

Tabs.Main0:AddButton({
    Title = "key tong daccauhub",
    Description = "quocdung",
    Callback = function()
        setclipboard("imspiderman")
    end
})

    Tabs.Main0:AddButton({
    Title = "youtube",
    Description = "quocdunginmeme",
    Callback = function()
        setclipboard("https://www.youtube.com/@SkibidiHu%E1%BB%B3nhQuocdung")
    end
})
...
Tabs.Main1:AddButton({
    Title="script script W-azure hub",
    Description="",
    Callback=function()
	  local Settings = {
  JoinTeam = "Pirates"; -- Pirates/Marines
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Bubu2k/Rubutv/refs/heads/main/rubuhubV5Y.lua"))()
  end
})
Tabs.Main3:AddButton({
    Title="Dragon Hub Kaitun",
    Description="",
    Callback=function()
	  local Settings = {
  JoinTeam = "Pirates"; -- Pirates/Marines
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Flontium2/Dragon-Hub/refs/heads/main/Kaitun.lua"))()
  end
})

Tabs.Main1:AddButton({
    Title="script grafity hub",
    Description="",
    Callback=function()
	  local Settings = {
  JoinTeam = "Pirates"; -- Pirates/Marines
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/vietdepzai25102010/VTD-Roblox-/refs/heads/main/vtd%20test"))()
  end
})
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/ParadozCode/CentuDox-Hub-Paradoz-Hub/refs/heads/main/CentuDox.lua", true))()
  end
})
Tabs.Main5:AddButton({
    Title="script pvp toca hub",
    Description="",
    Callback=function()
	  local Settings = {
  JoinTeam = "Pirates"; -- Pirates/Marines
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/onion132005-bit/v3/refs/heads/main/onion13v3.lua"))()
  end
})
Tabs.Main4:AddButton({
    Title="script sever vip 1 người",
    Description="",
    Callback=function()
	  local Settings = {
  JoinTeam = "Pirates"; -- Pirates/Marines
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/traurobloxdeptrai/traukhoaito/refs/heads/main/pvp.lua"))()
  end
})
Tabs.Main4:AddButton({
    Title="script teddy hop (mới hoạt động đc)",
    Description="",
    Callback=function()
	  local Settings = {
  JoinTeam = "Pirates"; -- Pirates/Marines
...
Tabs.Main4:AddButton({
    Title="script hop night (ko biết có hoạt đọng ko)",
    Description="",
    Callback=function()
	  local Settings = {
  JoinTeam = "Pirates"; -- Pirates/Marines
